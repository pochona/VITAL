...
PRINT "Creation de la clef etrangere de la table VTL_CONSULTATION vers la table VTL_ANIMAL"
ALTER TABLE VTL_CONSULTATION
ADD CONSTRAINT VTL_CONSULTATION_L_VTL_ANIMAL_FK FOREIGN KEY (VTL_CONSULTATION_L)
	REFERENCES VTL_ANIMAL(VTL_ANIMAL_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_CONSULTATION vers la table VTL_PROPRIETAIRE"
ALTER TABLE VTL_CONSULTATION
ADD CONSTRAINT VTL_CONSULTATION_ID_PROPRIETAIRE_VTL_PROPRIETAIRE_FK FOREIGN KEY (VTL_CONSULTATION_ID_PROPRIETAIRE)
	REFERENCES VTL_PROPRIETAIRE(VTL_PROPRIETAIRE_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_CONTRAT vers la table VTL_ANIMAL"
ALTER TABLE VTL_CONTRAT
ADD CONSTRAINT VTL_CONTRAT_ID_ANIMAL_VTL_ANIMAL_FK FOREIGN KEY (VTL_CONTRAT_ID_ANIMAL)
	REFERENCES VTL_ANIMAL(VTL_ANIMAL_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_CONTRAT vers la table VTL_PROPRIETAIRE"
ALTER TABLE VTL_CONTRAT
ADD CONSTRAINT VTL_CONTRAT_ID_PROPRIETAIRE_VTL_PROPRIETAIRE_FK FOREIGN KEY (VTL_CONTRAT_ID_PROPRIETAIRE)
	REFERENCES VTL_PROPRIETAIRE(VTL_PROPRIETAIRE_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_CONTRAT vers la table VTL_ASSURANCE"
ALTER TABLE VTL_CONTRAT
...
PRINT "Creation de la clef etrangere de la table VTL_HISTO_POIDS vers la table VTL_ANIMAL"
ALTER TABLE VTL_HISTO_POIDS
ADD CONSTRAINT VTL_HISTO_POIDS_ID_ANIMAL_VTL_ANIMAL_FK FOREIGN KEY (VTL_HISTO_POIDS_ID_ANIMAL)
	REFERENCES VTL_ANIMAL(VTL_ANIMAL_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_HISTO_TAILLE vers la table VTL_ANIMAL"
ALTER TABLE VTL_HISTO_TAILLE
ADD CONSTRAINT VTL_HISTO_TAILLE_ID_ANIMAL_VTL_ANIMAL_FK FOREIGN KEY (VTL_HISTO_TAILLE_ID_ANIMAL)
	REFERENCES VTL_ANIMAL(VTL_ANIMAL_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_POSITION vers la table VTL_ANIMAL"
ALTER TABLE VTL_POSITION
ADD CONSTRAINT VTL_POSITION_ID_ANIMAL_VTL_ANIMAL_FK FOREIGN KEY (VTL_POSITION_ID_ANIMAL)
	REFERENCES VTL_ANIMAL(VTL_ANIMAL_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_TRAITEMENT_MEDICAMENT vers la table VTL_TRAITREMENT"
ALTER TABLE VTL_TRAITEMENT_MEDICAMENT
...
PRINT "Creation de la clef etrangere de la table VTL_TRAITEMENT_MEDICAMENT vers la table VTL_MEDICAMENT"
ALTER TABLE VTL_TRAITEMENT_MEDICAMENT
...
PRINT "Creation de la clef etrangere de la table VTL_VACCINATION vers la table VTL_ANIMAL"
ALTER TABLE VTL_VACCINATION
ADD CONSTRAINT VTL_VACCINATION_ID_ANIMAL_VTL_ANIMAL_FK FOREIGN KEY (VTL_VACCINATION_ID_ANIMAL)
	REFERENCES VTL_ANIMAL(VTL_ANIMAL_ID);
GO

PRINT "Creation de la clef etrangere de la table VTL_VACCINATION vers la table VTL_VACCIN"
ALTER TABLE VTL_VACCINATION
...
PRINT "Creation de la clef etrangere de la table VTL_VACCINATION vers la table VTL_CONSULTATION"
ALTER TABLE VTL_VACCINATION
...
PRINT "=============================="
PRINT "Fin du script vital_create.sql"
PRINT "=============================="
