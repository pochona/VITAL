...
#Region " - "
    ...
    Public MustInherit Class (Of T As {VITAL., New})
...
#Region "Constantes publiques"
        ...
        Public Const TableName As String = Tables.~TEMP636291757526019432
...
#Region "Méthodes publiques"
        ...
        Public Function Diff(p_o_object As (Of T)) As Dictionary(Of String, Object())
