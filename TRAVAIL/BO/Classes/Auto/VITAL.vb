...
#Region "Tables du schéma VITAL."
    ...
    Public NotInheritable Class Tables
        ...
        ''' .
        ''' </summary>
        Public Const ~TEMP636291757526019432 As String = "~TEMP636291757526019432"
...
#Region "~TEMP636291757526019432 - "

    ''' <summary>
    ''' .
    ''' </summary>
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Modeler", "1.4")> _
    Public NotInheritable Class ~TEMP636291757526019432
...
#Region "Méthodes publiques"
        ...
        Public Shared Sub ClearAllCache(Optional p_b_force As Boolean = False)
            ' Clear cache pour les items de la classe 
            If .HasCache Then .CacheClear(p_b_force)
...
#Region "Initialisation"
        ...
        ''' <summary>
        ''' Initialise une nouvelle instance de la classe <see cref="" />.
        ''' </summary>
        Public Sub New()
